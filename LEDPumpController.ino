 ...
 */
   ...
   //Variables for added pump control
 ...
 void loop() {
   if (Serial.available() > 0) {
    ...
    /* This is the end of all the case testing code in the main loop. I'm going to be kludgy and get the LED state by reading the pin 8 state directly.
     * If it's high, we'll set pin 7 high, and reset a countdown timer for how long to keep pin 7 on. Once the coutdown reaches zero, we'll turn pin 7 off.
     */ 
     ...
     if (LEDstate == HIGH){
       ...
       //LED off and enough time elapsed, turn off pump
